...
public class PolybiusSquareCipher
{
	...
	static String encryption(String plainText) // Þifreleme metodu 
	{
		StringBuilder cipherText = new StringBuilder();
		
		for(int i = 0 ; i<plainText.length();i++) // Bu döngü ile metnin her karakterine karþýlýk gelen satýr ve sütun deðerleri elde edilir.
		{
	...
	static String decryption(String cipherText) // Þifre çözme metodu.
	{
	...
	static String turnPolybius(char character) // Ýçerisine gelen karaktere karþýlýk gelen satýr ve sütun deðerlerini bulur ve bu deðerleri birleþtirip döndürür.
	{
	...
	static char unTurnPolybius(int i,int j)  // Ýçerisine gelen satýr ve sütun deðerlerine karþýlýk gelen karakteri bulur ve bu karakteri döndürür.
	{
	...
	public static void main(String args[])
	{
		...
		System.out.println("Metnin Açýk Hali :"+plainText);
		...
		System.out.println("Metnin Cözülmüs Hali :"+plainText);
	}
}